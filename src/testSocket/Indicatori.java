...
public class Indicatori {
	...
	public Indicatori(String codalfa, Date timestampIndicatori,int totalTurnover,int turnover,int numberoftrades,int averageturnover,int marketorderdelta,float marketbuypercentage,double standardDeviation,float bidAskSpread,float bookImpact) {
