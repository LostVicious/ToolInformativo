...
def test_network(titoli = ['A2A','SRG','TRN','ENEL','EGPW'],indicatori=["regVolatility120","mreg120","mreg60","vwapRatio","vwapRatioFTSE","minuto"],NNN = 20,dropout=0.2,name="20neuroniDropout02"):
