...
def test_network(titoli = ['A2A','SRG','TRN','ENEL','EGPW'],indicatori=["mreg120","mreg60","vwapRatio","vwapRatioFTSE","minuto"],NNN = 20,dropout=0.2,use_custom_objective=False, activation='relu', name="20neuroniDropout02custom"):
