...
def test_network(titoli = ['A2A','SRG','TRN','ENEL','EGPW'],indicatori=["mreg120","mreg60","vwapRatio","vwapRatioFTSE","minuto"],NNN = 20,dropout=0.2,use_custom_objective=True, name="20neuroniDropout02custom"):
    ...
    optimizer = Adam(lr=0.05)  #fa schifo
