...
def test_network(
    ...
    indicatori=["ipercompratoTrades","bookImbalance30","vwapRatio","vwapRatioFTSE","minuto"],#"pDaChiusura","ipercompratoTrades","mreg120","mreg60","minuto"],
    NNN = 20,
    dropout=0.2,
    epoch=30,
